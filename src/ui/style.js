...
.ow-seg button.pending { color:#100b02; background:var(--amber); }
.ow-seg button:disabled { cursor:wait; opacity:.72; }
.ow-seg button:focus-visible, .ow-btn:focus-visible {
  outline:calc(2px * var(--k)) solid var(--amber); outline-offset:calc(2px * var(--k));
}
...
.ow-btn:disabled { cursor:wait; opacity:.58; }
.ow-btn.primary { background: var(--amber); border-color: var(--amber); color:#100b02; }
.ow-btn.primary:hover:not(:disabled) { background:#ffc251; }
.ow-menu .hint {
