...
export class WeaponSystem {
  ...
  async init(ctx) {
    ...
    this.batchStats = this.viewmodel.finalizeBatches();
    ...
    const batchNote = this.batchStats?.enabled
      ? ` · ${this.batchStats.sourceMeshes} rigid meshes in ${this.batchStats.draws} multi-draw batches`
      : '';
    console.info(
      `[weapons] ${this.states.size} weapons · ${(tris / 1000).toFixed(1)}k tris viewmodel${batchNote} · ` +
